...
let s:result = v:lua.require('vimtex.view').inverse_search(10, 'main.tex')
...
let s:result = v:lua.require('vimtex.view').inverse_search(2, 'included.tex')
...
let s:result = v:lua.require('vimtex.view').inverse_search(2, 'new.tex')
let s:log = v:lua.require('vimtex.log').get()
...
call v:lua.require('vimtex.view').inverse_search(3, 'included.tex')
