...
function M.load(_)
  vim.cmd [==[
function! VimtexSyntaxPackage_array() abort
  ...
  call VimtexSyntaxCore_new_arg('texNewcolumnArgName', {
        \ 'next': 'texNewcolumnOpt,texNewcolumnArg',
        \})

  call VimtexSyntaxCore_new_opt('texNewcolumnOpt', {
        \ 'next': 'texNewcolumnArg',
        \ 'opts': 'oneline',
        \})
  call VimtexSyntaxCore_new_arg('texNewcolumnArg', {
  ...
  call VimtexSyntaxCore_new_arg('texTabularPostPreArg', {
  ...
  syntax match texTabularCmd "\\\a\+"
        ...
        \ skipwhite skipnl
  call VimtexSyntaxCore_new_opt('texTabularCmdOpt', {
        \ 'next': 'texTabularCmdArg'
        \})
  call VimtexSyntaxCore_new_arg('texTabularCmdArg', {
        \ 'next': 'texTabularCmdArg',
...
call VimtexSyntaxPackage_array()
delfunction VimtexSyntaxPackage_array
  ]==]
end
