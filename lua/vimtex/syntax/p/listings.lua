...
function M.load(_)
  vim.cmd [==[
function! VimtexSyntaxPackage_listings() abort
  ...
  call VimtexSyntaxCore_new_arg('texLstsetArg', {
  ...
  call VimtexSyntaxCore_new_opt('texLstOpt')
  ...
  call VimtexSyntaxCore_new_opt('texLstInlineOpt', {
        \ 'next': 'texLstZoneInline'
        \})
  call VimtexSyntaxCore_new_arg('texLstZoneInline', {'contains': ''})
  call VimtexSyntaxCore_new_arg('texLstZoneInline', {
        \ 'contains': '',
  ...
  for l:nested in b:vimtex_syntax.listings.nested
    let l:cluster = v:lua.require('vimtex.syntax.nested').include(l:nested)
    ...
    call VimtexSyntaxCore_new_arg(l:grp_inline, {'contains': l:cluster})
    call VimtexSyntaxCore_new_arg(l:grp_inline, {
          \ 'contains': l:cluster,
          \ 'matcher': 'start="\z([|+/]\)" end="\z1"',
          \})
  endfor
...
call VimtexSyntaxPackage_listings()
delfunction VimtexSyntaxPackage_listings
  ]==]
end
