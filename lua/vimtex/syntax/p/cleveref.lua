...
function M.load(_)
  vim.cmd [==[
function! VimtexSyntaxPackage_cleveref() abort
  " \cref, \namecref, etc
  ...
  call VimtexSyntaxCore_new_arg('texCRefArg', {
        \ 'contains': 'texComment,@NoSpell',
        \})
  call VimtexSyntaxCore_new_arg('texCRefRangeArg', {
        \ 'next': 'texCRefArg',
        \ 'contains': 'texComment,@NoSpell',
        \})
  call VimtexSyntaxCore_new_opt('texCRefOpt', {
        \ 'next': 'texRefArg',
        \ 'opts': 'oneline',
        \})
  call VimtexSyntaxCore_new_arg('texCRNameArgType', {
        \ 'next': 'texCRNameArgSingular',
        \ 'contains': 'texComment,@NoSpell',
        \})
  call VimtexSyntaxCore_new_arg('texCRNameArgSingular', {
        \ 'next': 'texCRNameArgPlural',
        \ 'contains': 'texComment,@NoSpell'
        \})
  call VimtexSyntaxCore_new_arg('texCRNameArgPlural', {
        \ 'contains': 'texComment,@NoSpell'
        \})
...
call VimtexSyntaxPackage_cleveref()
delfunction VimtexSyntaxPackage_cleveref
  ]==]
end
