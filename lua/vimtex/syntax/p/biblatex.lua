...
function M.load(_)
  vim.cmd [==[
function! VimtexSyntaxPackage_biblatex() abort
  ...
  call VimtexSyntaxCore_new_arg('texRefArgs', {'next': 'texRefOpts,texRefArgs', 'contains': 'texComment,@NoSpell'})
  call VimtexSyntaxCore_new_opt('texRefOpts', {'next': 'texRefOpts,texRefArgs'})

  highlight def link texRefArgs texRefArg
  highlight def link texRefOpts texRefOpt
endfunction
call VimtexSyntaxPackage_biblatex()
delfunction VimtexSyntaxPackage_biblatex
  ]==]
end
