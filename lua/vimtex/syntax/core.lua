...
function! VimtexSyntaxCore_init_rules() abort " {{{1
  ...
  call VimtexSyntaxCore_new_arg('texGroup', {'opts': ''})
  ...
  call VimtexSyntaxCore_new_opt('texOpt', {'next': 'texArg'})
  call VimtexSyntaxCore_new_arg('texArg', {'next': 'texArg', 'opts': 'contained transparent'})
  ...
  call VimtexSyntaxCore_new_arg('texMathArg', {'contains': '@texClusterMath'})

  " Define basic simplified variants
  syntax match texBasicCmd "\%#=1\\[a-zA-Z@]\+" contained
  syntax match texBasicDelimiter "\%#=1[{}]" contained
  call VimtexSyntaxCore_new_opt('texBasicOpt', #{contains: '@texClusterBasicOpt'})
  ...
  call VimtexSyntaxCore_new_opt('texAuthorOpt', {'next': 'texAuthorArg'})
  call VimtexSyntaxCore_new_arg('texAuthorArg', {'contains': 'TOP,@Spell'})

  " \title
  syntax match texCmdTitle nextgroup=texTitleArg skipwhite skipnl "\%#=1\\title\>"
  call VimtexSyntaxCore_new_arg('texTitleArg')

  " \footnote
  syntax match texCmdFootnote nextgroup=texFootnoteArg skipwhite skipnl "\%#=1\\footnote\>"
  call VimtexSyntaxCore_new_arg('texFootnoteArg')

  " \if \else \fi
  syntax match texCmdConditional nextgroup=texConditionalArg skipwhite skipnl "\%#=1\\\(if[a-zA-Z@]\+\|fi\|else\)\>"
  call VimtexSyntaxCore_new_arg('texConditionalArg')
  ...
  call VimtexSyntaxCore_new_arg('texFileArg', {'contains': '@NoSpell,texCmd,texComment'})
  call VimtexSyntaxCore_new_arg('texFilesArg', {'contains': '@NoSpell,texCmd,texComment,texOptSep'})
  call VimtexSyntaxCore_new_opt('texFileOpt', {'next': 'texFileArg'})
  call VimtexSyntaxCore_new_opt('texFilesOpt', {'next': 'texFilesArg'})
  ...
  syntax match texNewcmdArgName "\%#=1\\[a-zA-Z@]\+"
        ...
        \ contained
  call VimtexSyntaxCore_new_arg('texNewcmdArgName', {
        \ 'next': 'texNewcmdOpt,texNewcmdArgBody',
        \ 'contains': ''
        \})
  call VimtexSyntaxCore_new_opt('texNewcmdOpt', {
        \ 'next': 'texNewcmdOpt,texNewcmdArgBody',
        \ 'opts': 'oneline',
        \})
  call VimtexSyntaxCore_new_arg('texNewcmdArgBody')
  ...
  call VimtexSyntaxCore_new_arg('texNewenvArgName', {'next': 'texNewenvArgBegin,texNewenvOpt'})
  call VimtexSyntaxCore_new_opt('texNewenvOpt', {
        \ 'next': 'texNewenvArgBegin,texNewenvOpt',
        \ 'opts': 'oneline'
        \})
  call VimtexSyntaxCore_new_arg('texNewenvArgBegin', {'next': 'texNewenvArgEnd'})
  call VimtexSyntaxCore_new_arg('texNewenvArgEnd')
  ...
  call VimtexSyntaxCore_new_arg('texDefArgBody')
  ...
  call VimtexSyntaxCore_new_opt('texRefOpt', {'next': 'texRefOpt,texRefArg'})
  call VimtexSyntaxCore_new_arg('texRefArg', {'contains': 'texComment,@NoSpell'})

  " \bibitem[label]{marker}
  syntax match texCmdBibitem "\%#=1\\bibitem\>"
        \ nextgroup=texBibitemOpt,texBibitemArg skipwhite skipnl
  call VimtexSyntaxCore_new_opt('texBibitemOpt', {
        \ 'next': 'texBibitemArg'
        \})
  call VimtexSyntaxCore_new_arg('texBibitemArg',
  ...
  call VimtexSyntaxCore_new_arg('texPartArgTitle')

  " Item elements in lists
  syntax match texCmdItem "\%#=1\\item\>" nextgroup=texItemLabel
  call VimtexSyntaxCore_new_opt('texItemLabel')

  " \begin \end environments
  syntax match texCmdEnv "\%#=1\v\\%(begin|end)>" nextgroup=texEnvArgName
  call VimtexSyntaxCore_new_arg('texEnvArgName', {
        \ 'contains': 'texComment,@NoSpell',
        \ 'next': 'texEnvOpt',
        \})
  call VimtexSyntaxCore_new_opt('texEnvOpt')
  ...
  syntax match texCmdTabular "\\begin{tabular}"
        ...
        \ contains=texCmdEnv
  call VimtexSyntaxCore_new_opt('texTabularOpt', {
        \ 'next': 'texTabularArg',
        \ 'contains': 'texComment,@NoSpell',
        \})
  call VimtexSyntaxCore_new_arg('texTabularArg', {
  ...
  call VimtexSyntaxCore_new_arg('texTabularLength', {
        \ 'contains': 'texLength,texCmd'
        \})
  call VimtexSyntaxCore_new_arg('texTabularMulti', {'next': 'texTabularArg'})
  ...
  call VimtexSyntaxCore_new_opt('texParboxOptPos', {
        \ 'next': 'texParboxOptHeight,texParboxArgWidth',
        \ 'contains': 'texBoxOptPosVal,texComment',
        \})
  call VimtexSyntaxCore_new_opt('texParboxOptHeight', {
        \ 'next': 'texParboxOptIPos,texParboxArgWidth',
        \ 'contains': 'texLength,texCmd,texComment',
        \})
  call VimtexSyntaxCore_new_opt('texParboxOptIPos', {
        \ 'next': 'texParboxArgWidth',
        \ 'contains': 'texBoxOptIPosVal,texComment',
        \})
  call VimtexSyntaxCore_new_arg('texParboxArgWidth', {
        \ 'next': 'texParboxArgContent',
        \ 'contains': 'texLength,texCmd,texComment',
        \})
  call VimtexSyntaxCore_new_arg('texParboxArgContent')
  ...
  call VimtexSyntaxCore_new_arg('texNewthmArgName', {
        \ 'next': 'texNewthmOptCounter,texNewthmArgPrinted',
        \ 'contains': 'TOP,@Spell'
        \})
  call VimtexSyntaxCore_new_opt('texNewthmOptCounter',
        \ {'next': 'texNewthmArgPrinted'}
        \)
  call VimtexSyntaxCore_new_arg('texNewthmArgPrinted',
        \ {'next': 'texNewthmOptNumberby'}
        \)
  call VimtexSyntaxCore_new_opt('texNewthmOptNumberby')

  " \begin{mytheorem}[custom title]
  call VimtexSyntaxCore_new_opt('texTheoremEnvOpt', {
  ...
  call VimtexSyntaxCore_new_arg('texVerbZoneInline', {
        \ 'contains': '',
  ...
  call VimtexSyntaxCore_new_arg('texMathGroup', {'contains': '@texClusterMath'})

  " Define math environment boundaries
  syntax match texCmdMathEnv "\%#=1\v\\%(begin|end)>" contained nextgroup=texMathEnvArgName
  call VimtexSyntaxCore_new_arg('texMathEnvArgName',
        \ {'contains': 'texComment,@NoSpell'})
  ...
  call VimtexSyntaxCore_new_arg('texEnvMArgName', {
        \ 'contains': 'texComment,@NoSpell',
        \ 'next': 'texEnvOpt',
        \ 'skipwhite': v:false
        \})
  ...
  call VimtexSyntaxCore_new_arg('texMathZoneEnsured', {'contains': '@texClusterMath'})
  ...
  call VimtexSyntaxCore_new_arg('texMathTextArg')
  ...
  call VimtexSyntaxCore_new_arg('texMathArrayArg', {
        \ 'contains': '@texClusterTabular'
        \})
  ...
  call VimtexSyntaxCore_new_arg('texE3Group', {
  ...
  call VimtexSyntaxCore_new_opt('texE3Opt', {'next': 'texE3Arg'})
  call VimtexSyntaxCore_new_arg('texE3Arg', {
        \ 'next': 'texE3Arg',
        \ 'contains': '@texClusterBasic,texSpecialChar',
...
" }}}1
function! VimtexSyntaxCore_init_post() abort " {{{1
  ...
  call v:lua.require('vimtex.syntax.packages').init()
endfunction

" }}}1
function! VimtexSyntaxCore_init_custom() abort " {{{1
  ...
  for l:item in g:vimtex_syntax_custom_cmds
    call VimtexSyntaxCore_new_cmd(l:item)
  endfor

  for l:item in g:vimtex_syntax_custom_cmds_with_concealed_delims
    call VimtexSyntaxCore_new_cmd_with_concealed_delims(l:item)
  endfor

  for l:item in g:vimtex_syntax_custom_envs
    call VimtexSyntaxCore_new_env(l:item)
  endfor
endfunction

" }}}1
function! VimtexSyntaxCore_init_options() abort " {{{1
...
function! VimtexSyntaxCore_init_highlights() abort " {{{1
...
function! VimtexSyntaxCore_new_arg(grp, ...) abort " {{{1
  let l:cfg = extend({
        \ 'contains': 'TOP,@NoSpell',
...
" }}}1
function! VimtexSyntaxCore_new_opt(grp, ...) abort " {{{1
  let l:cfg = extend({
        \ 'opts': '',
        \ 'next': '',
...
" }}}1
function! VimtexSyntaxCore_new_cmd(cfg) abort " {{{1
  ...
  if !empty(l:cfg.nextgroup)
    ...
    if l:cfg.opt
      ...
      call VimtexSyntaxCore_new_opt(l:group_opt, l:opt_cfg)
    ...
    if l:cfg.arg
      ...
      call VimtexSyntaxCore_new_arg(l:group_arg, l:arg_cfg)
...
" }}}1
function! VimtexSyntaxCore_new_cmd_with_concealed_delims(cfg) abort " {{{1
  if empty(get(a:cfg, 'name')) | return | endif
...
function! VimtexSyntaxCore_new_env(cfg) abort " {{{1
  ...
  if type(l:cfg.nested) == v:t_dict && !empty(l:cfg.nested)
    for [l:lang, l:predicate] in items(l:cfg.nested)
      ...
      call VimtexSyntaxCore_new_env(l:nested_cfg)
    endfor
    return
  endif
  ...
  if l:cfg.math
    ...
    if !empty(l:cfg.nested)
      let l:nested = v:lua.require('vimtex.syntax.nested').include(l:cfg.nested)
      if !empty(l:nested)
...
function! VimtexSyntaxCore_conceal_cmd_pairs(cmd, pairs) abort " {{{1
...
function! VimtexSyntaxCore_get_alphabet_map(type) abort " {{{1
...
function! s:match_math_sub_super() abort " {{{1
  ...
  if &encoding !=# 'utf-8'
    call v:lua.require('vimtex.log').warning(
...
function! s:match_math_symbols() abort " {{{1
  ...
  for [l:cmd, l:alphabet_map] in [
        ...
        \]
    let l:pairs = VimtexSyntaxCore_get_alphabet_map(l:alphabet_map)
    call VimtexSyntaxCore_conceal_cmd_pairs(l:cmd, l:pairs)
  endfor
endfunction
...
function! s:match_math_unicode() abort " {{{1
  ...
  if !exists('s:re_math_symbols')
    let l:symbols = map(v:lua.require('vimtex.util').uniq_unsorted(s:cmd_symbols), 'v:val[1]')
...
function! s:match_conceal_spacing() abort " {{{1
  ...
  call VimtexSyntaxCore_new_arg('texConcealedArg', {
        \ 'opts': 'contained conceal',
        \ 'contains': 'texSpecialChar,texConcealedArgGroup',
        \})
  call VimtexSyntaxCore_new_arg('texConcealedArgGroup', {
...
function! s:match_conceal_cites_brackets() abort " {{{1
  ...
  call VimtexSyntaxCore_new_opt('texRefConcealedOpt1', {
        ...
        \})
  call VimtexSyntaxCore_new_opt('texRefConcealedOpt2', {
        \ 'opts': g:vimtex_syntax_conceal_cites.verbose ? '' : 'conceal',
        \ 'contains': '@texClusterOpt,texSpecialChar',
  ...
  call VimtexSyntaxCore_new_arg('texRefConcealedArg', {
  ...
  call VimtexSyntaxCore_new_opt('texRefConcealedPOpt1', {
        \ 'opts': g:vimtex_syntax_conceal_cites.verbose ? '' : 'conceal',
        \ 'contains': '@texClusterOpt,texSpecialChar',
        \ 'next': 'texRefConcealedPOpt2,texRefConcealedPArg',
        \})
  call VimtexSyntaxCore_new_opt('texRefConcealedPOpt2', {
        \ 'opts': g:vimtex_syntax_conceal_cites.verbose ? '' : 'conceal',
        \ 'contains': '@texClusterOpt,texSpecialChar',
  ...
  syntax match texRefConcealedPOpt2 "\[\s*\]" contained conceal
        \ skipwhite nextgroup=texRefConcealedPArg
  call VimtexSyntaxCore_new_arg('texRefConcealedPArg', {
...
function! s:match_conceal_sections() abort " {{{1
  ...
  call VimtexSyntaxCore_new_arg('texPartConcArgTitle', {
